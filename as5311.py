...
class AS5311:
    ...
    def report(self, mode = 3):
        ...
        if mode == 2:
            print('%s (%s) position - inverted - mode 2' %(databits, bin(databits),hex(databits)))
        elif mode == 3:
            print('%s (%s) position - mode 3' %(databits, bin(databits),hex(databits)))
        elif mode == 1:
            print('%s (%s) mT field strength inverted - mode 1' %(databits, bin(databits),hex(databits)))
        elif mode == 0:
